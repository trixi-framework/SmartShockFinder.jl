...
@testset "Test_1dNNPP" begin
    ...
    @testset "Test_generate_Traindata_1dNNPP" begin
        ...
        @test isfile(joinpath("datasets", "1d", "traindata1dNNPP.h5"))
        # copy to example directory so train_network1d can use this set
        @test_nowarn cp(joinpath("datasets", "1d", "traindata1dNNPP.h5"),"examples/1d/traindata1dNNPP.h5", force = true)
    end
    ...
    @testset "Test_generate_Validdata_1dNNPP" begin
        ...
        @test isfile(joinpath("datasets", "1d", "validdata1dNNPP.h5"))
        @test_nowarn cp(joinpath("datasets", "1d", "validdata1dNNPP.h5"),joinpath("examples", "1d", "validdata1dNNPP.h5"), force = true)
    end
    ...
    @test_nowarn rm(joinpath("datasets", "1d"), recursive=true, force=true)
    @test_nowarn rm(joinpath("examples", "1d", "traindata1dNNPP.h5"), recursive=true, force=true)
    @test_nowarn rm(joinpath("examples", "1d", "validdata1dNNPP.h5"), recursive=true, force=true)
end